//
//  What_NextUITests_UnreadNotificationsPopupViewController.swift
//  What NextUITests
//
...
class What_NextUITests_UnreadNotificationsPopupViewController: XCTestCase {

    // check that user is taken to the main login screen after pressing unread
    // notifications popup
    func testClosePopupScreen() throws {
